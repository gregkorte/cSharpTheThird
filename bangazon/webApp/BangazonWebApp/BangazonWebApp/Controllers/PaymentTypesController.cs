...
namespace BangazonWebApp.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeId,DateCreated,Name,AccountNumber,IsActive")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentTypeId,DateCreated,Name,AccountNumber,IsActive")] PaymentType paymentType)
        {
